                            ...
                            <nav
                                ...
                                <ul className="blcok lg:flex 2xl:ml-20">
                                    <li className="group relative">
                                        <a
                                            href="#about"
                                            className="mx-8 flex py-2 text-base font-medium text-dark group-hover:text-primary dark:text-white lg:ml-7 lg:mr-0 lg:inline-flex lg:px-0 lg:py-6 lg:text-white lg:group-hover:text-white lg:group-hover:opacity-70 xl:ml-10">
                                            À Propos
                                        </a>
                                    </li>
                                    <li className="group relative">
                      ...
                      <clipPath id="clip0_2172_3070">
                        <rect width="24" height="24" fill="white"/>
                            ...
                            <div className="hidden sm:flex">
                                <a href="/send-mail" className="loginBtn px-[22px] py-2 text-base font-medium text-white hover:opacity-70">
                                    Mail
                                </a>
                                <a href="/call"
                                    className="signUpBtn flex rounded-md bg-white bg-opacity-20 px-6 py-2 text-base font-medium text-white duration-300 ease-in-out hover:bg-opacity-100 hover:text-dark">
                                    Appeler
                                </a>
                            </div>
                        </div>
