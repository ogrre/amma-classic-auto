...
const Hero: React.FC = () => {
    return (
        <div id="home" className="relative min-h-screen overflow-hidden bg-hero-background bg-no-repeat bg-center pt-[120px] md:pt-[130px] lg:mt-[160px]">
            <div className="container">
                <div className="-mx-4 flex flex-wrap items-center">
                    <div className="w-full px-4">
                        <div className="hero-content wow fadeInUp mx-auto max-w-[780px] text-center" data-wow-delay=".2s">
                            <h1 className="-mt-28 text-2xl font-bold leading-snug text-white uppercase sm:text-3xl sm:leading-snug lg:text-4xl lg:leading-[1.2]">
