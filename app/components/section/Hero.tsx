        ...
        <div id="home" className="relative overflow-hidden bg-primary pt-[120px] md:pt-[130px] lg:pt-[160px]">
            <div className="container">
                <div className="-mx-4 flex flex-wrap items-center">
                    <div className="w-full px-4">
                        <div className="hero-content wow fadeInUp mx-auto max-w-[780px] text-center"
                            ...
                            <h1 className="mb-3 text-3xl font-bold leading-snug text-white sm:text-4xl sm:leading-snug lg:text-5xl lg:leading-[1.2]">
                                Votre rêve de voiture ancienne, entre des mains expertes.
                            </h1>
                    ...
                    <div className="w-full px-4">
                        <div className="wow fadeInUp relative z-10 mx-auto" data-wow-delay=".25s">
                            <div className="mt-16">
                                <img src="/assets/images/hero/porsche.png"
                                    alt="hero"
