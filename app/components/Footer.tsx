                    ...
                    <div className="w-full px-4 sm:w-1/2 md:w-1/2 lg:w-4/12 xl:w-3/12">
                        <div className="w-full mb-10">
                            ...
                            <p className="mb-8 max-w-[270px] text-base text-gray-7">
                                Pour l'avenir, j'aimerai donner accès à l'atelier aux plus
                            ...
                            <div className="flex items-center -mx-3">
                                <a href="https://www.facebook.com/profile.php/?id=61555763086425" className="px-3 text-gray-7 hover:text-white">
                                ...
                                <a href="https://www.instagram.com/aurick.martin/" className="px-3 text-gray-7 hover:text-white">
                                    <svg width="22" height="22" viewBox="0 0 22 22" fill="none"
                                         xmlns="http://www.w3.org/2000/svg"
                                         className="fill-current">
                                        <path
